 ...
 * - change method access allow to override private method 
 * </p>
 */
@Singleton
public class JsonContainerConfig extends AbstractContainerConfig {
     ...
     */
    @Inject
    public JsonContainerConfig(@Named("shindig.containers.default") String containers, @Nullable @Named("shindig.host") String host,
            @Nullable @Named("shindig.port") String port, Expressions expressions) throws ContainerConfigException {
        this.expressions = expressions;
        this.host = host;
        this.port = port;

        // [devacfr] remove to extend
        /*
     ...
     */
    protected Map<String, Map<String, Object>> createContainers(JSONObject json) {
     ...
     * @throws ContainerConfigException
     */
    protected JSONObject loadContainers(String path) throws ContainerConfigException {
