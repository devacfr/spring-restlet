...
"gadgets.parent" : "parent",

// KBase configuration
// context of base of all services
"contextBase" : "/gadgets",
"hostDomain" : "http://%host%",
"fullContextPath" : "http://%host%${Cur['contextBase']}",
// End config
...
"gadgets.iframeBaseUri" : "${Cur['contextBase']}/ifr",
"gadgets.uri.iframe.basePath" : "${Cur['contextBase']}/ifr",

// jsUriTemplate will have %host% and %js% substituted.
// No locked domain special cases, but jsUriTemplate must
// never conflict with a lockedDomainSuffix.
"gadgets.jsUriTemplate" : "${Cur['fullContextPath']}/js/%js%",
...
"gadgets.uri.js.host" : "${Cur['hostDomain']}",
"gadgets.uri.js.path" : "${Cur['contextBase']}/js",
	
	
// Callback URL.  Scheme relative URL for easy switch between https/http.
"gadgets.uri.oauth.callbackTemplate" : "//%host%${Cur['contextBase']}/oauthcallback",
...
"gadgets.osDataUri" : "${Cur['fullContextPath']}/rpc",
...
"gadgets.uri.concat.path" : "${Cur['contextBase']}/concat",
...
"gadgets.uri.proxy.path" : "${Cur['contextBase']}/proxy",
...
"gadgets.features" : {
  "core.io" : {
    ...
    "proxyUrl" : "//%host%${Cur['contextBase']}/proxy?container=default&refresh=%refresh%&url=%url%%rewriteMime%",
    "jsonProxyUrl" : "//%host%${Cur['contextBase']}/makeRequest"
  },
  "views" : {
    "profile" : {
      "isOnlyVisible" : false,
      "urlTemplate" : "${Cur['fullContextPath']}/profile?{var}",
      "aliases": ["DASHBOARD", "default"]
    },
    "canvas" : {
      "isOnlyVisible" : true,
      "urlTemplate" : "${Cur['fullContextPath']}/canvas?{var}",
      "aliases" : ["FULL_PAGE"]
    }
  },
  "tabs": {
  ...
  "rpc" : {
    ...
    "parentRelayUrl" : "{Cur['contextBase']}/container/rpc_relay.html",
  ...
  "opensocial" : {
    ...
    "path" : "${Cur['fullContextPath']}/rpc",
    // Path to issue invalidate calls
    "invalidatePath" : "${Cur['fullContextPath']}/rpc",
    "domain" : "shindig",
    "enableCaja" : false,
    "supportedFields" : {
  ...
  "osapi" : {
    ...
    "endPoints" : [ "${Cur['fullContextPath']}/rpc" ]
  },
  "osml": {
